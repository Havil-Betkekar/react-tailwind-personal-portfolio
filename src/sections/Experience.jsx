...
const experiences = [
  ...
  },
  {
    ...
    description:
      "Developed and maintained Java-based modules for a high-traffic government services platform. Optimized PostgreSQL queries for better performance and created 15+ Jasper and Crystal Reports used across departments.",
    technologies: [
      "JavaScript",
      "HTML/CSS",
      "Java",
  ...
  },
  {
    ...
    company: "Webware.io",
    description:
      "Built and deployed responsive, cross-browser websites from wireframes to production. Developed UI and delivered projects within defined timelines.",
